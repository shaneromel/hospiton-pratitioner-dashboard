...
export class ManageComponent implements OnInit {
    ...
    columns: {
      ...
      booking_timestamp:{
        ...
        valuePrepareFunction:(cell, row)=>{
          ...
          return cell ? `${date.getHours().toString().padStart(2, '0')}:${date.getMinutes().toString().padStart(2, '0')}:${date.getSeconds().toString().padStart(2, '0')}` : "NA";
        },
        sort:true,
        sortDirection:'desc',
        filter:false
  ...
  constructor(private apiService:APIService, private toastrService:ToastrService, private communicationService:CommunicationService, private router:Router) { 
